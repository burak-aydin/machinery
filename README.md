...
[![Travis Status for burak-aydin/machinery](https://travis-ci.org/burak-aydin/machinery.svg?branch=master&label=linux+build)](https://travis-ci.org/burak-aydin/machinery)
[![godoc for burak-aydin/machinery](https://godoc.org/github.com/nathany/looper?status.svg)](http://godoc.org/github.com/burak-aydin/machinery/v1)
[![codecov for burak-aydin/machinery](https://codecov.io/gh/burak-aydin/machinery/branch/master/graph/badge.svg)](https://codecov.io/gh/burak-aydin/machinery)

[![Go Report Card](https://goreportcard.com/badge/github.com/burak-aydin/machinery)](https://goreportcard.com/report/github.com/burak-aydin/machinery)
[![GolangCI](https://golangci.com/badges/github.com/burak-aydin/machinery.svg)](https://golangci.com)
[![OpenTracing Badge](https://img.shields.io/badge/OpenTracing-enabled-blue.svg)](http://opentracing.io)

[![Sourcegraph for burak-aydin/machinery](https://sourcegraph.com/github.com/burak-aydin/machinery/-/badge.svg)](https://sourcegraph.com/github.com/burak-aydin/machinery?badge)
...
```go
import (
  "github.com/burak-aydin/machinery/v2"
  backendsiface "github.com/burak-aydin/machinery/v2/backends/iface"
  brokersiface "github.com/burak-aydin/machinery/v2/brokers/iface"
  locksiface "github.com/burak-aydin/machinery/v2/locks/iface"
)
...
```sh
go get github.com/burak-aydin/machinery/v2
```

If you want to use legacy v1 version, you still can:

```sh
go get github.com/burak-aydin/machinery
```
...
> Keep in mind AMQP is not recommended as a result backend. See [Keeping Results](https://github.com/burak-aydin/machinery#keeping-results)
...
Then just set the logger in your setup code by calling `Set` function exported by `github.com/burak-aydin/machinery/v1/log` package:
...
```go
import (
  "github.com/burak-aydin/machinery/v1/config"
  "github.com/burak-aydin/machinery/v1"
)
...
```go
import (
  "github.com/burak-aydin/machinery/v1/tasks"
)
